...
Certifique-se de clonar e inicializar o microsserviço de notificação, disponível no repositório: [https://github.com/JoabioVilela/notificacao-sms](https://github.com/JoabioVilela/notificacao-sms)
