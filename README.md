# (Gestão de Relacionamento com o Cliente, Customer Relationship Management, CRM) - Sistema Distribuído baseado em Arquitetura de Microsserviços,Mensageria,Backend Java API RESTful
